...
exports.getScreenshotGenerator = getScreenshotGenerator;
exports.generateProjectScreenshot = generateProjectScreenshot;
exports.cleanupScreenshotGenerator = cleanupScreenshotGenerator;
...
class ScreenshotGenerator {
    ...
    async generateScreenshot(options) {
        const { url, projectName, width = 1200, height = 630, waitTime = 5000 } = options;
        try {
            await this.init();
            ...
            const screenshotsDir = path_1.default.join(process.cwd(), 'public', 'images', 'projects', 'generated');
            ...
            // Save screenshot
            (0, fs_1.writeFileSync)(filePath, screenshot);
    ...
    async generateBulkScreenshots(projects) {
